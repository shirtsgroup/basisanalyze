...
class AlchemicalState(object):
    ...
    * Add receptor modulation back in?
    ...
    def __init__(self, relativeRestraints, ligandElectrostatics, ligandAttraction, ligandRepulsion, ligandTorsions, ligandPMEFull=None):
        """
...
class AbsoluteAlchemicalFactory(object):
    ...
    def defaultComplexProtocolExplicit(cls):
        ...
        alchemical_states = list()
        #Testing stuff
        alchemical_states.append(AlchemicalState(0.00, 1.00, 1.00, 1.00, 1., ligandPMEFull=1.00)) # fully interacting
        alchemical_states.append(AlchemicalState(0.00, 0.90, 1.00, 1.00, 1., ligandPMEFull=0.90)) 
        alchemical_states.append(AlchemicalState(0.00, 0.80, 1.00, 1.00, 1., ligandPMEFull=0.80)) 
        alchemical_states.append(AlchemicalState(0.00, 0.70, 1.00, 1.00, 1., ligandPMEFull=0.70)) 
        alchemical_states.append(AlchemicalState(0.00, 0.60, 1.00, 1.00, 1., ligandPMEFull=0.60)) 
        alchemical_states.append(AlchemicalState(0.00, 0.50, 1.00, 1.00, 1., ligandPMEFull=0.50)) 
        alchemical_states.append(AlchemicalState(0.00, 0.40, 1.00, 1.00, 1., ligandPMEFull=0.40)) 
        alchemical_states.append(AlchemicalState(0.00, 0.30, 1.00, 1.00, 1., ligandPMEFull=0.30)) 
        alchemical_states.append(AlchemicalState(0.00, 0.20, 1.00, 1.00, 1., ligandPMEFull=0.20)) 
        alchemical_states.append(AlchemicalState(0.00, 0.10, 1.00, 1.00, 1., ligandPMEFull=0.10)) 
        alchemical_states.append(AlchemicalState(0.00, 0.00, 1.00, 1.00, 1., ligandPMEFull=0.00)) # dischargd
        alchemical_states.append(AlchemicalState(0.00, 0.00, 1.00, 1.00, 1., ligandPMEFull=1.00)) # PME only
        alchemical_states.append(AlchemicalState(0.00, 0.00, 1.00, 1.00, 1., ligandPMEFull=0.50)) # Different PME to isolate the solvent-solvent vs solvent-solute interactions
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.95,  0.95, 1.)) 
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.90, 0.90, 1.)) 
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.80, 0.80, 1.))
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.70, 0.70, 1.))
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.60, 0.60, 1.))
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.50, 0.50, 1.))
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.40, 0.40, 1.))
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.30, 0.30, 1.))
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.20, 0.20, 1.))
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.10, 0.10, 1.))
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.00, 0.00, 1.)) # discharged, LJ annihilated#
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.00, 1.00, 1.)) # discharged, dispersion off
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 1.00, 0.00, 1.)) # discharged, dispersion off
    ...
    def defaultVacuumProtocol(cls):
        ...
        alchemical_states.append(AlchemicalState(0.00, 0.00, 1.00, 1.00, 1., ligandPMEFull=1.00)) # PME only
        alchemical_states.append(AlchemicalState(0.00, 0.00, 1.00, 1.00, 1., ligandPMEFull=0.50)) # Different PME to isolate the solvent-solvent vs solvent-solute interactions
        alchemical_states.append(AlchemicalState(0.00, 0.00, 0.00, 0.00, 1., ligandPMEFull=0.00)) # discharged, LJ annihilated
        #Adding one more state for testing, will probably need to modify the analyze file
        alchemical_states.append(AlchemicalState(0.00, 0.00, 0.00, 1.00, 1., ligandPMEFull=0.00)) # discharged, attraction turned off
    ...
    def defaultSolventProtocolExplicit(cls):
        ...
        alchemical_states.append(AlchemicalState(0.00, 1.00, 1.00, 1.00, 1.)) # fully interacting
        alchemical_states.append(AlchemicalState(0.00, 0.00, 1.00, 1.00, 1.)) # discharged
        #alchemical_states.append(AlchemicalState(0.00, 0.00, 0.95, 0.95, 1.)) 
        alchemical_states.append(AlchemicalState(0.00, 0.00, 0.90, 0.90, 1.)) 
        alchemical_states.append(AlchemicalState(0.00, 0.00, 0.80, 0.80, 1.))
        alchemical_states.append(AlchemicalState(0.00, 0.00, 0.70, 0.70, 1.))
